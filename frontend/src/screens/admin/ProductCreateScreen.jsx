    ...
    const submitHandler = async (e) => {
        ...
        try {
            await createProduct({
                ...
                price,
                discountPrice,
                image, // Main image (first one or selected)
                images, // All images
                brand,
                category,
                description,
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-border-color p-8">
                <h1 className="text-3xl font-display font-bold text-text-main mb-6 border-b border-border-color pb-4">Create Product</h1>
